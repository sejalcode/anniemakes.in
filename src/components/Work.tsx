...
const PROJECTS = [
  { id: 1, num: "01", category: "ADS", img: ads, title: "Drive the Future", description: "A high-energy commercial film created for a next-gen automotive brand. This project combines cinematic storytelling, dynamic visuals, and sleek VFX to deliver a powerful message about innovation and performance.", youtube: "https://youtube.com" },
  { id: 2, num: "02", category: "SHORT FILMS", img: shorts, title: "Through the Lens", description: "An intimate short film exploring the craft of filmmaking, blending vérité moments with painterly cinematography.", youtube: "https://youtube.com" },
  { id: 3, num: "03", category: "DOCUMENTARY", img: doc, title: "Above the Clouds", description: "A documentary capturing the silent vastness of mountain ecosystems at dawn.", youtube: "https://youtube.com" },
  { id: 4, num: "04", category: "VFX", img: vfx, title: "Red Horizon", description: "A sci-fi VFX showcase blending practical lighting and CG environments to construct an alien atmosphere.", youtube: "https://youtube.com" },
  { id: 5, num: "05", category: "DIGITAL CONTENT", img: digital, title: "Signal", description: "Vertical-format digital content engineered for social storytelling with cinematic depth.", youtube: "https://youtube.com" },
];
  ...
  return (
    <section id="work" className="relative min-h-screen w-full py-24 overflow-hidden bg-background">
      ...
      <div className="absolute inset-y-0 left-0 w-1/3 opacity-30 pointer-events-none">
        <img src="/src/assets/hero-ribbon.jpg" alt="" className="w-full h-full object-cover -scale-x-100" style={{ mixBlendMode: "screen" }} />
      </div>
      <div className="absolute inset-y-0 right-0 w-1/3 opacity-30 pointer-events-none">
        <img src="/src/assets/hero-ribbon.jpg" alt="" className="w-full h-full object-cover" style={{ mixBlendMode: "screen" }} />
      </div>
          ...
          {!project ? (
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-12 items-start">
                <div className="relative aspect-video overflow-hidden rounded-sm border border-accent-red/40 glow-red">
