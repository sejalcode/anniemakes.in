...
export const PROJECTS: Project[] = [
  { id: 4, num: "01", category: "VFX", title: "Turning Imagination Into Reality", img: vfx, video: null, youtube: "https://youtu.be/V8lETeKC4ZY", description: "Transform ordinary footage into extraordinary cinematic experiences with professional VFX services. From realistic visual effects and seamless compositing to CGI environments and custom effects for music videos, advertisements, and commercial shoots, every frame is crafted with precision, creativity, and attention to detail..", instagram: "https://www.instagram.com/anniemakesstudio/" },
  { id: 5, num: "02", category: "3D MODELS", title: "Professional 3D Asset Creation", img: digital, video: null, youtube:"https://youtube.com/shorts/3CSYHQmnBDM?feature=share", description: "Bring your ideas to life with custom 3D models crafted with exceptional detail and realism. Whether it's a product, object, environment, or a unique concept, every model is designed to meet your creative vision and industry standards.", instagram: "https://www.instagram.com/anniemakesstudio/" },
  { id: 1, num: "03", category: "ADS", title: "Go Zero — Ice Cream Ad", img: ads, video: goZeroAd, description: "A high-energy commercial film created for a next-gen brand. Combines cinematic storytelling, dynamic visuals, and sleek VFX to deliver a powerful message about innovation and craft.", youtube: "https://youtube.com" },
