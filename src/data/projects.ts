...
export const PROJECTS: Project[] = [
  { id: 4, num: "01", category: "VFX", title: "Red Horizon", img: vfx, video: null, videos: [goZeroAd, goZeroAd], description: "A sci-fi VFX showcase blending practical lighting and CG environments to construct an alien atmosphere.", youtube: "https://youtube.com", instagram: "https://www.instagram.com/anniemakesstudio/" },
