...
export const PROJECTS: Project[] = [
  { id: 4, num: "01", category: "VFX", title: "Turning Imagination Into Reality", img: vfx, video: null, videos: "https://youtu.be/V8lETeKC4ZY", description: "Transform ordinary footage into extraordinary cinematic experiences with professional VFX services. From realistic visual effects and seamless compositing to CGI environments and custom effects for music videos, advertisements, and commercial shoots, every frame is crafted with precision, creativity, and attention to detail..", instagram: "https://www.instagram.com/anniemakesstudio/" },
